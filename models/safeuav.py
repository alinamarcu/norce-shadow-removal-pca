...
def get_unet_MDCB_with_deconv_layers(input_shape=(1024,1024,3), init_nb=64, lr=0.0001, loss=bce_dice_loss, num_classes=1, last_layer_name='output'):
    ...
    classify = Conv2D(num_classes, (1, 1), activation='sigmoid', name=last_layer_name)(up1)
...
def get_unet_MDCB_with_deconv_layers_new_size(input_shape=(1024,1024,3), init_nb=64, lr=0.0001, loss=bce_dice_loss, num_classes=1, last_layer_name='output'):
    ...
    up3 = Conv2DTranspose(init_nb*4, (3, 3), activation='relu', padding='same', strides=(2, 2))(dilate_all_added)
    #up3 = concatenate([down3, up3])
    up3 = special_concatenate_crop(down3, up3, 1)
    up3 = Conv2D(init_nb*4, (3, 3), activation='relu', padding='same')(up3)
    up3 = Conv2D(init_nb*4, (3, 3), activation='relu', padding='same')(up3)
