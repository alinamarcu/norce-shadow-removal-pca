...
from .multigpu import ModelMGPU, make_parallel
...
class ModelMGPU(Model):
    def __init__(self, ser_model, gpus):
        pmodel = multi_gpu_model(ser_model, gpus, cpu_merge=True, cpu_relocation=True)
...
def get_unet_MDCB_with_maxPooling(input_shape=(1024,1024,3), init_nb=64, lr=0.0001, loss=bce_dice_loss):
    ...
    model = Model(inputs=inputs, outputs=classify, name='MSMT-Stage-1-MaxPooling')
...
def get_unet_MDCB_with_deconv_layers_multi_gpu(input_shape=(1024,1024,3), init_nb=64, lr=0.0001, loss=bce_dice_loss, num_classes=1, num_gpus=2):
    ...
    parallel_model = multi_gpu_model(model, gpus=num_gpus, cpu_merge=True, cpu_relocation=True)
    #parallel_model = ModelMGPU(serial_model = model, gdev_list=['/gpu:0', '/gpu:1', '/gpu:2','/gpu:3'])
    #parallel_model = make_parallel(serial_model = model, gdev_list=['/gpu:0', '/gpu:1', '/gpu:2','/gpu:3','/gpu:4','/gpu:5',])
    #parallel_model = ModelMGPU(ser_model = model, gpus=6)
